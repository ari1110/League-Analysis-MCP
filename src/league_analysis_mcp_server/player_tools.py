...
def register_player_tools(mcp: FastMCP, app_state: Dict[str, Any]):
    ...
    @mcp.tool()
    def get_player_draft_analysis(league_id: str, player_key: str, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def get_player_ownership(league_id: str, player_key: str, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def get_player_percent_owned_by_week(league_id: str, player_key: str, week: int, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def get_player_stats_by_date(league_id: str, player_key: str, selected_date: str, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def get_player_stats_by_week(league_id: str, player_key: str, week: int, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @mcp.tool()
    def get_player_stats_for_season(league_id: str, player_key: str, sport: str = "nfl", season: Optional[str] = None) -> Dict[str, Any]:
        """
